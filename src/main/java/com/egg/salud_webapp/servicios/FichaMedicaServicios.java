...
public class FichaMedicaServicios implements UserDetailsService {
    ...
    public void crear(LocalDate fecha, String diagnostico, String tratamiento, String notas, Long id) {
        ...
        HistoriaClinica historiaClinica = historiaClinicaRepositorio.buscarPorId(2L);// (idHistoriaClinica)
        ...
        if (historiaClinica != null) {
            ...
            if (!fichasMedicas.isEmpty()) {
                ...
                for (FichaMedica fichaMedica : fichasMedicas) {
                    if (fichaMedica.getId() == 7L) { // Cambia esto según tu lógica de búsqueda
                        System.out.println(fichaMedica);
                        return;
                    }
                }
                ...
                throw new Exception("No hay fichas médicas asociadas a la historia clínica");
            }
        } else {
